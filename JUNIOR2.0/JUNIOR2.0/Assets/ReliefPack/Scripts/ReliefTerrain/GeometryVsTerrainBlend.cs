...
//#endif
	...
	public void SyncMaterialProps() {
		...
		if (script_terrain.BumpGlobalCombined) {
			renderer.sharedMaterial.SetTexture("_BumpMapPerlin", script_terrain.BumpGlobalCombined);
		}
		if (script_terrain.globalSettingsHolder.TERRAIN_RippleMap) {
			renderer.sharedMaterial.SetTexture("TERRAIN_RippleMap", script_terrain.globalSettingsHolder.TERRAIN_RippleMap);
		}
		...
		if (script_terrain.globalSettingsHolder.VerticalTexture) {
			renderer.sharedMaterial.SetTexture("_VerticalTexture", script_terrain.globalSettingsHolder.VerticalTexture);
		}
		...
		renderer.sharedMaterial.SetFloat("TERRAIN_FresnelPow", script_terrain.globalSettingsHolder.TERRAIN_FresnelPow);
		renderer.sharedMaterial.SetFloat("TERRAIN_FresnelOffset", script_terrain.globalSettingsHolder.TERRAIN_FresnelOffset);
		...
		renderer.sharedMaterial.SetFloat("TERRAIN_ReflDistortion", script_terrain.globalSettingsHolder.TERRAIN_ReflDistortion);
		...
		if (script_terrain.globalSettingsHolder.TERRAIN_CausticsTex) {
			renderer.sharedMaterial.SetTexture("TERRAIN_CausticsTex", script_terrain.globalSettingsHolder.TERRAIN_CausticsTex);
		}
