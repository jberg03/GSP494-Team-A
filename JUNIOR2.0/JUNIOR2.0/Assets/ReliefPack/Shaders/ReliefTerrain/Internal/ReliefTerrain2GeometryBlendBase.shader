...
SubShader {
	...
	Fog { Mode Off }
	CGPROGRAM
	#pragma surface surf CustomBlinnPhong vertex:vert finalcolor:customFog fullforwardshadows
	#pragma target 3.0
	#pragma glsl
...
ZTest LEqual	
CGPROGRAM
	#pragma surface surf CustomBlinnPhong vertex:vert finalcolor:customFog fullforwardshadows decal:blend
	#pragma target 3.0
	#pragma glsl
	#pragma only_renderers d3d9
	#pragma multi_compile RTP_PM_SHADING RTP_SIMPLE_SHADING
